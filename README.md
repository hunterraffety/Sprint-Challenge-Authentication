...
- Sessions allow for persistence among multiple interactions with a website. Each client has their on unique sessions to send credentials, verify credentials, store cookings, validate cookies, etc.

1. What does bcrypt do to help us store passwords in a secure manner.

- bcrypt provides a way to hash data, specify a salt, and the amount of times we want to hash and (if you want) salt the data.

1. What does bcrypt do to slow down attackers?

- It hashes things a specific amount of times as given when passed as an option
